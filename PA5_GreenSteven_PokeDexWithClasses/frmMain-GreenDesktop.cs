...
namespace PA5_GreenSteven_PokeDexWithClasses
{
    public partial class frmMain : Form
    {
        ...
        {
            txtbxName.Text = dgvPokemon.SelectedRows[0].Cells["pokeName"].Value.ToString();
            txtbxType.Text = dgvPokemon.SelectedRows[0].Cells["pokeType"].Value.ToString();
            txtbxHP.Text = dgvPokemon.SelectedRows[0].Cells["pokeHP"].Value.ToString();
            txtbxHeight.Text = dgvPokemon.SelectedRows[0].Cells["pokeHeight"].Value.ToString();
            txtbxWeight.Text = dgvPokemon.SelectedRows[0].Cells["pokeWeight"].Value.ToString();
        ...
        {
            _Pokedex.Sort(delegate(Pokemon x, Pokemon y) { return x.pokeName.CompareTo(y.pokeName); });
            pokeGrid();
        }

        private void btnType_Click(object sender, EventArgs e)
        {
            _Pokedex.Sort(delegate(Pokemon x, Pokemon y) { return x.pokeType.CompareTo(y.pokeType); });
            pokeGrid();
        }

        private void btnHP_Click(object sender, EventArgs e)
        {
            _Pokedex.Sort(delegate(Pokemon x, Pokemon y) { return x.pokeHP.CompareTo(y.pokeHP); });
            pokeGrid();
        }
        ...
        {
            _Pokedex.Sort(delegate(Pokemon x, Pokemon y) { return x.pokeWeight.CompareTo(y.pokeWeight); });
            pokeGrid();
        }

        private void btnHeight_Click(object sender, EventArgs e)
        {
            _Pokedex.Sort(delegate(Pokemon x, Pokemon y) { return x.pokeHeight.CompareTo(y.pokeHeight); });
            pokeGrid();
        }
